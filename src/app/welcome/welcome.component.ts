...
export class WelcomeComponent implements OnInit, AfterContentInit {
  ...
  po_script_mid_dev: string = 'rates -';       // 'process service terms <- ';
  po_script_out_dev: string = 'terms -';      // 'send deal proposal -> ';
  po_script_deal_dev: string = 'book -';      // 'confirm deal <-> ';
  //    Execution ------- 's' - state
  ps_script_in_dev: string = 'inputs -';       // 'query service state -> ';
  ps_script_mid_dev: string = 'result -';    // 'process service result <- ';
  ...
  so_script_mid_dev: string = '- rates'; // ' -> process project terms';
  ...
  ts_script_mid_dev: string = '- result'; // ' -> process task';
